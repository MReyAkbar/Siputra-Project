		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
			<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
				<div>
					...
					<p class="mt-1 text-sm text-gray-600">Ringkasan transaksi 7 hari terakhir</p>
				</div>
					<div class="flex flex-wrap items-center gap-3">
						...
						<div x-data="{ open: false }" class="relative">
							...
							<div x-show="open" x-transition @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-10">
								...
								<a href="{{ url('admin/laporan/mingguan') }}" class="block px-4 py-3 text-sm font-medium bg-blue-50 text-blue-700">Mingguan</a>
		...
		<div class="bg-white rounded-xl shadow-lg overflow-hidden">
			<div class="overflow-x-auto">
				<table class="min-w-full divide-y divide-gray-200" id="laporan-table">
					...
					<tbody class="bg-white divide-y divide-gray-200">
						@php
							$data = [
								['2025-11-30', 'IKN009', 'Ikan Salmon', 'Pembelian', 800],
								['2025-11-21', 'IKN010', 'Ikan Tuna', 'Penjualan', 620],
								['2025-11-14', 'IKN011', 'Ikan Gurame', 'Pembelian', 920],
								['2025-11-7', 'IKN012', 'Ikan Patin	', 'Penjualan', 580],
								['2025-10-28', 'IKN013', 'Ikan Mas', 'Pembelian', 1100],
								['2025-10-19', 'IKN014', 'Ikan Bawal', 'Penjualan', 720],
								['2025-10-12', 'IKN015', 'Ikan Ogos', 'Pembelian', 1300],
							];
						@endphp
			...
			<div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex items-center justify-between">
				<div class="text-sm text-gray-700">
					Menampilkan 1 sampai 10 dari 7 hasil (Minggu ini)
				</div>
