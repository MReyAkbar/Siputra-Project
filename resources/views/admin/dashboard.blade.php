...
<div class="space-y-6">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-gradient-to-br from-violet-50 to-violet-100 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
      <div class="flex items-start justify-between">
        <div class="flex-1">
          <div class="flex items-center gap-2 mb-2">
            ...
            <p class="text-sm font-semibold text-violet-800">Stok Tersedia</p>
          </div>
          <div class="space-y-2">
            <p class="text-3xl font-bold text-gray-800">
              {{ number_format($kapasitasTersedia ?? 0, 0, ',', '.') }} <span class="text-lg">kg</span>
            </p>
            <p class="text-xs text-gray-600">Total stok di semua gudang</p>
          </div>
        </div>
