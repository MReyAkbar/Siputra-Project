        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Input data dan informasi gudang baru</p>
                </div>

                <a href="{{ route('admin.gudang.index') }}"
                class="inline-flex items-center gap-2 text-[#134686] hover:text-[#0d3566] transition">
        ...
        <div class="w-full max-w-2xl">
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
                <div class="p-8 bg-[#134686]">
                    ...
                    <form action="{{ route('admin.gudang.store') }}"
                          method="POST"
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select name="status_sewa"
                                    ...
                                    <option value="tersedia" {{ old('status_sewa') == 'tersedia' ? 'selected' : '' }}>
                                        Tersedia
                                    </option>

                                    <option value="tidak_tersedia" {{ old('status_sewa') == 'tidak_tersedia' ? 'selected' : '' }}>
                                        Tidak Tersedia
                                    </option>
                            ...
                            <div>
                                ...
                                <textarea name="deskripsi" rows="4"
                                          class="w-full px-4 py-3 rounded-lg bg-white text-gray-900"
                                          placeholder="Informasi gudang ...">{{ old('deskripsi') }}</textarea>
