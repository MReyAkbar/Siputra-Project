<aside class="w-64 fixed h-screen bg-[#134686] text-white flex flex-col">
  ...
  <nav class="flex-1 p-4 space-y-0 overflow-y-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
    ...
    <div>
      <a href="{{ url('/admin/laporan') }}" class="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-[#103a6a] transition-all duration-200">
        <div class="flex items-center gap-3">
    ...
    <div x-data="{ open: false }" class="mt-2">
      ...
      <ul x-show="open"
          ...
          class="mt-1 ml-5 space-y-0"
          style="display:none">
          <li><a href="{{ url('/admin/transaksi/pembelian') }}" class="block px-4 py-3 rounded-lg text-gray-300 hover:bg-[#103a6a] transition-all duration-200">Pembelian</a></li>
          <li><a href="{{ url('/admin/transaksi/penjualan') }}" class="block px-4 py-3 rounded-lg text-gray-300 hover:bg-[#103a6a] transition-all duration-200">Penjualan</a></li>
      </ul>
    </div>
